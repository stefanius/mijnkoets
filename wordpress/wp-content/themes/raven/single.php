												...
												<div <?php post_class('actual_post') ?> id="post-<?php the_ID(); ?>">
                                                    ...
                                                    <div class="post_author_bio">
                                                        ...
                                                        <div class="post_author_bio_social">
                                                            	...
                                                            	<?php 
																	$authorswebsitelink =  raven_get_custom_field('authors_website', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_website">
                                                                	...
                                                                	<p><a href="<?php echo $authorswebsite; ?>"><?php _e("Visit Author's Website",'raven'); ?></a></p>
                                                            	</div>
                                                                <?php endif; ?>
                                                            
                                                        	
                                                            	<?php 
																	$authorstwitterlink =  raven_get_custom_field('authors_twitter', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_twitter">                                                           
                                                            		<p><a href="https://www.twitter.com/<?php echo $authorstwitter; ?>"><?php _e("Follow On Twitter",'raven'); ?></a></p>
                                                            	</div>  
                                                            	<?php endif; ?>
                                                            	...
                                                            	<?php 
																	$authorsfacebooklink =  raven_get_custom_field('authors_facebook', get_the_ID(), true);
                                                                ...
                                                                <div class="authors_facebook">                                                           
                                                            		<p><a href="<?php echo $authorsfacebook; ?>"><?php _e("Like On Facebook",'raven'); ?></a></p>
                                                            	</div>
																<?php endif; ?>                                                                                                                      
